...
def test_correct_local_mean(brisque: Brisque):
    expected = numpy.array([[0.17496204, 0.23679088, 0.25726582],
...
def test_correct_local_deviation(brisque: Brisque):
    expected = numpy.array([[0.19316824, 0.1893495, 0.18346567],
...
def test_correct_mscn(brisque: Brisque):
    expected = numpy.array([[1.08211202, 0.78358554, 0.69892418],
...
def test_correct_mscn_horizontal(brisque: Brisque):
    expected = numpy.array([[0.84792733, 0.54766688, 0.48011944],
...
def test_correct_mscn_vertical(brisque: Brisque):
    expected = numpy.array([[0.84780868, 0.35117304, 0.23056021],
...
def test_correct_mscn_diagonal(brisque: Brisque):
    expected = numpy.array([[0.48496118, 0.25848819, 0.2189311],
...
def test_correct_mscn_secondary_diagonal(brisque: Brisque):
    expected = numpy.array([[0.61392038, 0.31323106, 0.2266071],
...
def test_correct_features(brisque: Brisque):
    expected = numpy.array([2.5831384826064765, 0.3246368578871716, 0.804777755330943, 0.08897788603336909,
                            0.06840297824679546, 0.15626675254070954, 0.8049535099622015, 0.07516229246587908,
                            0.07504565998142923, 0.14971732887316655, 0.7375110596615735, -0.010579280060541355,
                            0.13411853419378322, 0.12239672859496961, 0.7504928455135851, -0.007148436867571834,
                            0.1252422296198859, 0.11758092662669493])
